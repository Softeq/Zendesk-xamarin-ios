...
#ifndef COMMONUISDK_SWIFT_H
#define COMMONUISDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CommonUISDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC11CommonUISDK16ActionOptionView")
...
@interface InputField (SWIFT_EXTENSION(CommonUISDK)) <UITextViewDelegate>
