...
namespace SupportProvidersSDK.Bindings
{
    ...
    {
        // +(void)performRequestWithZendesk:(ZDKZendesk * _Nonnull)zendesk urlRequest:(NSURLRequest * _Nonnull)urlRequest completionHandler:(void (^ _Nonnull)(NSURLResponse * _Nullable, NSData * _Nullable, NSError * _Nullable))completionHandler;
        [Static]
        [Export("performRequestWithZendesk:urlRequest:completionHandler:")]
        void PerformRequestWithZendesk(ZDKZendesk zendesk, NSUrlRequest urlRequest, Action<NSUrlResponse, NSData, NSError> completionHandler);
        ...
        // +(void)logErrorWithUrl:(NSURL * _Nonnull)url response:(NSURLResponse * _Nullable)response error:(NSError * _Nullable)error;
        [Static]
        [Export("logErrorWithUrl:response:error:")]
        void LogErrorWithUrl(NSUrl url, [NullAllowed] NSUrlResponse response, [NullAllowed] NSError error);
    ...
    interface ZDKHelpCenterBlips
    {
        ...
        [Static]
        [Export("blipArticleViewed:url:navigatorLanguage:pageId:pageLocale:")]
        void BlipArticleViewed(string pageTitle, string url, string navigatorLanguage, long pageId, string pageLocale);
    ...
    // @interface ZDKListArticleQuery : NSObject
    [BaseType(typeof(NSObject))]
    [DisableDefaultCtor]
    interface ZDKListArticleQuery
    {
        // @property (readonly, nonatomic) NSInteger perPage;
        [Export("perPage")]
        nint PerPage { get; }
        ...
        // -(instancetype _Nonnull)initWithPerPage:(NSInteger)perPage page:(NSInteger)page __attribute__((objc_designated_initializer));
        [Export("initWithPerPage:page:")]
        [DesignatedInitializer]
        IntPtr Constructor(nint perPage, nint page);
    }
    ...
    // @interface SupportProvidersSDK_Swift_534
    interface SupportProvidersSDK_Swift_534
    {
    ...
    interface ZDKCommentWithUser
    {
        ...
        ZDKCommentWithUser BuildCommentWithUser(ZDKComment comment, ZDKUser[] users);
    }
    ...
    interface ZDKCommentsResponse
    {
        ...
        ZDKCommentWithUser[] CommmentsWithUsers { get; }

        // +(NSArray *)parseData:(NSDictionary *)dictionary;
        [Static]
        [Export("parseData:")]
        ZDKCommentWithUser[] ParseData(NSDictionary dictionary);
    }
    ...
    interface ZDKCreateRequest
    {
        ...
        [Export("attachments", ArgumentSemantic.Copy)]
        ZDKUploadResponse[] Attachments { get; set; }
    ...
    interface ZDKHelpCenterArticleVote
    {
        ...
        ZDKHelpCenterArticleVote[] ParseArticleVotes(NSDictionary json);
    }
    ...
    interface ZDKHelpCenterAttachment
    {
        ...
        ZDKHelpCenterAttachment[] ParseAttachments(NSDictionary json);
    ...
    interface ZDKHelpCenterCategory
    {
        ...
        ZDKHelpCenterCategory[] ParseCategories(NSDictionary json);
    }
    ...
    interface ZDKHelpCenterFlatArticle
    {
        ...
        // @property (nonatomic, strong) int * section;
        [Export("section", ArgumentSemantic.Strong)]
        unsafe IntPtr Section { get; set; }
    ...
    interface ZDKHelpCenterOverviewContentModel
    {
        ...
        // @property (assign, nonatomic) int navBarConversationsUIType __attribute__((deprecated("Deprecated as of 1.10.0.1, use ZDKHelpCenterConversationsUIDelegate instead.")));
        [Export("navBarConversationsUIType")]
        int NavBarConversationsUIType { get; set; }
    ...
    interface ZDKHelpCenterProvider
    {
        ...
        void GetArticlesWithSectionId(string sectionId, NSString[] labels, ZDKHelpCenterCallback callback);
        ...
        // -(void)searchArticles:(id)search withCallback:(ZDKHelpCenterCallback)callback;
        [Export("searchArticles:withCallback:")]
        void SearchArticles(NSObject search, ZDKHelpCenterCallback callback);
        ...
        [Export("getFlatArticles:withCallback:")]
        void GetFlatArticles(ZDKListArticleQuery query, ZDKHelpCenterCallback callback);
    ...
    interface ZDKHelpCenterSection
    {
        ...
        ZDKHelpCenterSection[] ParseSections(NSDictionary json);
    }
    ...
    interface ZDKHelpCenterSimpleArticle
    {
        ...
        ZDKHelpCenterSimpleArticle[] ParseDeflectionSearchResults(NSDictionary json);
    ...
    interface ZDKStringUtil
    {
        ...
        string CsvStringFromArray(NSString[] array);
    }
    ...
    [BaseType(typeof(ZDKDictionaryCreatable))]
    interface ZDKTicketField : ZDKDictionaryCreatable
    {
    ...
    [BaseType(typeof(ZDKDictionaryCreatable))]
    interface ZDKTicketForm : ZDKDictionaryCreatable
    {
    ...
    // typedef void (^ZDKUploadCallback)(int *, NSError *);
    unsafe delegate void ZDKUploadCallback(IntPtr arg0, NSError arg1);
