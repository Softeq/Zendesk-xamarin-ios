...
namespace SupportSDK.Bindings
{
	...
	*/
	...
	interface ZDKHelpCenterUi
	{
		...
		//[Verify(MethodToProperty)]
		UIViewController BuildHelpCenterOverviewUi { get; }
	...
	[BaseType(typeof(NSObject))]
	interface ZDKArticleUiConfiguration : IZDKConfiguration
	{
	...
	*/
	...
	{
		[Wrap("WeakChildDelegate")]//, Abstract]
		[NullAllowed]
		IZDKContainerChildControllerDelegate ChildDelegate { get; set; }
	...
	[Protocol, Model(AutoGeneratedName = true)]
	[BaseType(typeof(NSObject))]
	interface IZDKContainerChildControllerDelegate
	{
	...
	// @interface SupportSDK_Swift_1569 (ContainerViewController) <ZDKContainerChildControllerDelegate>
	//[Category]
	//[BaseType(typeof(ContainerViewController))]
	//interface ContainerViewController_SupportSDK_Swift_1569 : IZDKContainerChildControllerDelegate
	//{
	...
	//	[DesignatedInitializer]
	//	IntPtr Constructor(IZDKCoordinator coordinator);
	...
	*/
	...
	interface ZDKCoordinator
	{
		...
		void With(Action<ZDKContainerChild> present, IZDKContainerChildControllerDelegate containerDelegate);
	}
	...
	{
        // -(instancetype _Nonnull)initWithPresentingViewController:(UIViewController * _Nonnull)presentingViewController configurations:(NSArray<id<ZDKConfiguration>> * _Nonnull)configurations engines:(NSArray<id<ZDKEngine>> * _Nonnull)engines __attribute__((objc_designated_initializer));
        [Export("initWithPresentingViewController:configurations:engines:")]
        [DesignatedInitializer]
        IntPtr Constructor(UIViewController presentingViewController, ZDKConfiguration[] configurations, IZDKEngine[] engines);
	...
	//{
	//	// -(instancetype _Nonnull)initWithHelpCenterController:(UIViewController<ZDKContainerChild> * _Nonnull)helpCenterController uiConfigurations:(NSArray<id<ZDKConfiguration>> * _Nonnull)uiConfigurations __attribute__((objc_designated_initializer));
	//	[Export("initWithHelpCenterController:uiConfigurations:")]
	//	[DesignatedInitializer]
	//	IntPtr Constructor(ZDKContainerChild helpCenterController, ZDKConfiguration[] uiConfigurations);
	...
	//	[Export("startWithPresent:with:")]
	//	void StartWithPresent(Action<ZDKContainerChild> present, IZDKContainerChildControllerDelegate containerDelegate);
	//}

	// @interface ZDKHelpCenterUiConfiguration : NSObject <ZDKConfiguration>
	[BaseType(typeof(NSObject))]
	interface ZDKHelpCenterUiConfiguration : IZDKConfiguration
	{
	...
	interface ZDKRequestUi
	{
		...
		// +(UIViewController * _Nonnull)buildRequestUiWith:(NSArray<id<ZDKConfiguration>> * _Nonnull)configurations __attribute__((warn_unused_result));
		[Static]
		[Export("buildRequestUiWith:")]
		UIViewController BuildRequestUiWith(IZDKConfiguration[] configurations);
		...
		// +(UIViewController * _Nonnull)buildRequestUiWithRequestId:(NSString * _Nonnull)requestId configurations:(NSArray<id<ZDKConfiguration>> * _Nonnull)configurations __attribute__((warn_unused_result));
		[Static]
		[Export("buildRequestUiWithRequestId:configurations:")]
		UIViewController BuildRequestUiWithRequestId(string requestId, ZDKConfiguration[] configurations);
	}

	// @interface ZDKRequestUiConfiguration : NSObject <ZDKConfiguration>
	[BaseType(typeof(NSObject))]
	interface ZDKRequestUiConfiguration : IZDKConfiguration
	{
	...
	{
		// -(BOOL)isConversationOngoing __attribute__((warn_unused_result));
